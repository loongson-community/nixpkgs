...
qtModule {
  ...
  ++ lib.optionals stdenv.hostPlatform.isLoongArch64 [
    (fetchpatch {
      ...
      url = "https://github.com/lcpu-club/loongarch-packages/raw/f75364e1cef6295b0b75df70134b661835eda9de/qt6-webengine/add-loong64-support.patch";
      stripLen = 2;
      extraPrefix = "";
      hash = "sha256-D4eWQCrFHhkqF6cfwQhSFJxHZmtSgMHMy3O06ZE3zX0=";
    })
  ];
